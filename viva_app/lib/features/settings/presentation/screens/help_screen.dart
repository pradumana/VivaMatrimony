...
class HelpScreen extends StatelessWidget {
  ...
  static const _faqs = [
    _Faq('How do I get verified?', 'You can verify by providing a reference from an existing Viva member, or by uploading your caste certificate. Verification typically takes 1-2 business days for certificate review.'),
    ...
    _Faq('How do I report a fake profile?', 'On any profile, tap the ⋮ menu → Report. Our team reviews all reports within 24-48 hours.'),
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          Container(
            ...
            child: Row(children: [
              ...
              Expanded(child: Column(
                ...
                children: [
                  const Text('Contact Support', style: TextStyle(fontFamily: 'Poppins', fontSize: 15, fontWeight: FontWeight.w700, color: Colors.white)),
                  Text(AppConstants.supportEmail, style: TextStyle(fontFamily: 'Poppins', fontSize: 12, color: Colors.white.withOpacity(0.9))),
                  const Text('Response within 24 hours', style: TextStyle(fontFamily: 'Poppins', fontSize: 11, color: Colors.white70)),
                ],
              )),
              IconButton(
          ...
          const Text('Frequently Asked Questions', style: TextStyle(fontFamily: 'Poppins', fontSize: 16, fontWeight: FontWeight.w700)),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(children: [
        ListTile(
          title: Text(widget.faq.question, style: const TextStyle(fontFamily: 'Poppins', fontSize: 13, fontWeight: FontWeight.w600)),
        ...
        if (_expanded)
          Padding(
            ...
            child: Text(widget.faq.answer, style: const TextStyle(fontFamily: 'Poppins', fontSize: 13, color: AppTheme.textSecondary, height: 1.6)),
          ),
      ]),
    );
  }
